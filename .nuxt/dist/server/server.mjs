import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, computed, ref, Suspense, nextTick, mergeProps, Transition, provide, watch, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { sanitizeStatusCode, createError as createError$1, getHeader, setCookie } from "h3";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/backend-BAWwxABy.js"),
    children: [
      {
        name: "backend-dashboard",
        path: "dashboard",
        meta: __nuxt_page_meta$7 || {},
        component: () => import("./_nuxt/dashboard-vDoUNXfV.js")
      },
      {
        name: "backend-posts",
        path: "posts",
        meta: __nuxt_page_meta$6 || {},
        component: () => import("./_nuxt/posts-CvDs1Hyk.js")
      },
      {
        name: "backend-users",
        path: "users",
        meta: __nuxt_page_meta$5 || {},
        component: () => import("./_nuxt/users-DBFniCaK.js")
      }
    ]
  },
  {
    name: "index_archive",
    path: "/index_archive",
    component: () => import("./_nuxt/index_archive-C7pJj2ux.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-3Xh-fU0p.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/login-BFRz4XfB.js")
  },
  {
    name: "register_arc",
    path: "/register_arc",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/register_arc-CwDZMkM3.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/register-B0ErwnUH.js")
  },
  {
    name: "sample",
    path: "/sample",
    component: () => import("./_nuxt/sample-C4vgK4M5.js")
  },
  {
    name: "verify",
    path: "/verify",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/verify-C7Yq3EcP.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-ClG7J8mX.js")
};
...
const layouts = {
  auth: () => import("./_nuxt/auth-CNBZPyyy.js"),
  backend: () => import("./_nuxt/backend-CHPnnbDr.js"),
  default: () => import("./_nuxt/default-Cad147gG.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CYAh2VX6.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BvA52b9J.js"));
