    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2 space-y-4">
          <a class="text-2xl font-bold">NUXT PRISMA</a>
          <p class="text-sm">
            Promise your reader something valuable. Will you teach her how to
            learn a new skill? Will you persuade her to do something she’s never
            done before?
          </p>
          <!-- Social Media Icons -->
