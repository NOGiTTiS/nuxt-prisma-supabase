...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.Cu46YgQA.mjs').then(interopDefault),
  ...
  "layouts/backend.vue": () => import('./_nuxt/backend-styles.e_z-N3an.mjs').then(interopDefault),
  "layouts/backend.vue?vue&type=style&index=0&scoped=430db02d&lang.css": () => import('./_nuxt/backend-styles.WJFt6vhy.mjs').then(interopDefault)
}